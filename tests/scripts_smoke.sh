...
SCRIPT
    ...
    assert_contains "$pkg_root/usr/share/applications/codex-desktop.desktop" "Actions=new-window;new-isolated-instance;"
    assert_contains "$pkg_root/usr/share/applications/codex-desktop.desktop" "Desktop Action new-window"
    assert_contains "$pkg_root/usr/share/applications/codex-desktop.desktop" "Name=New Isolated Instance"
    ...
    assert_contains "$pkg_root/usr/share/applications/codex-desktop.desktop" "CHROME_DESKTOP=codex-desktop.desktop /usr/bin/codex-desktop"
...
SCRIPT
    ...
    assert_contains "$capture_dir/AppDir/codex-desktop.desktop" "Actions=new-window;new-isolated-instance;"
    assert_contains "$capture_dir/AppDir/codex-desktop.desktop" "[Desktop Action new-window]"
    assert_contains "$capture_dir/AppDir/codex-desktop.desktop" "Name=New Isolated Instance"
...
PY
    ...
    assert_contains "$REPO_DIR/packaging/linux/codex-desktop.desktop" "Actions=new-window;new-isolated-instance;CheckForUpdates;InstallReadyUpdate;"
    assert_contains "$REPO_DIR/packaging/linux/codex-desktop.desktop" "[Desktop Action new-window]"
    assert_contains "$REPO_DIR/packaging/linux/codex-desktop.desktop" "Name=New Isolated Instance"
    ...
    assert_contains "$REPO_DIR/contrib/user-local-install/files/.local/share/applications/codex-desktop.desktop" "Actions=new-window;new-isolated-instance;"
    assert_contains "$REPO_DIR/contrib/user-local-install/files/.local/share/applications/codex-desktop.desktop" "Name=New Isolated Instance"
...
EOF
    ...
    assert_contains "$current_entry" "Actions=new-window;new-isolated-instance;"
